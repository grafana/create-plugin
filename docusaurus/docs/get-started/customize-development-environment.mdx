---
id: customize-development-environment
title: Customize your development environment
description: Customize your development environment for Grafana plugin development.
  - grafana
  - plugins
  - plugin
  - create-plugin
...
Do not edit the `.config/` directory files. If you attempt to do so, then you may experience issues such as failure to compile or load your plugin in Grafana. Instead of changing the files directly, follow the instructions in this topic to make advanced configurations.
...
The following alternative customization excludes "libs" via rules in addition to "node_modules". It also provides nodejs fallbacks for Webpack v5.
