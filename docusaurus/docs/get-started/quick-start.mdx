...
Grafana plugin development allows you to create many different types of user experiences using [supported](/key-concepts/backend-plugins/grafana-plugin-sdk-for-go) features. For example, you can make:
